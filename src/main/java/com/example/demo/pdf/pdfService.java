            ...
            try {
                try {
                    try {
                        ...
                        URL_file = "F:\\dev\\distribution\\smart_front-end-master\\smart_front\\src\\revenu_PDF\\Rapport_" + u.get().getNom() + " " + u.get().getPrenom() + "-" + formater.format(d) + ".pdf";
                        ...
                        imgBank = Image.getInstance("F:\\dev\\distribution\\smart_back_end-main\\smart_back_end\\src\\main\\resources\\Images\\smart_technology.png");
...
////////////////////////////Paageeeeeeeeeeeeeeeeee 2
                        ...
                        if(details.get(0)!=null) {
                            ...
                            Runtime.getRuntime()
                                    .exec("rundll32 url.dll,FileProtocolHandler F:\\dev\\distribution\\smart_front-end-master\\smart_front\\src\\revenu_PDF\\Rapport_" + u.get().getNom() + " " + u.get().getPrenom() + "-" + formater.format(d) + ".pdf");
        ...
        return "RAPPORT-" + u.get().getNom() + " " + u.get().getPrenom() + "-" + formater.format(d) + ".pdf";
