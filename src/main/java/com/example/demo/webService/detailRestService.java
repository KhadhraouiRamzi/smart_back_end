...
public class detailRestService {
	...
	public ResponseEntity<ResponseMessage> rapportArtisteOrange(@Valid @RequestBody revenueRequest revReq)
			throws pdfExceptionNoDataFound, pdfExceptionDateFormat {
