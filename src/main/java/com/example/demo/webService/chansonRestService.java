...
public class chansonRestService {
	...
	@RequestMapping(path = "/chansonArtiste/by-id/{id}", method = RequestMethod.GET)
	public List<chanson> recherchechansArtId(@PathVariable("id") Integer id) {
		return ChansonRepository.chansonArtiste(id);
	}
